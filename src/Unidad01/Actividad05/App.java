package Unidad01.Actividad05;

import java.util.ArrayList;

import Unidad01.Actividad05.utils.Employee;
import Unidad01.Actividad05.utils.Product;
import Unidad01.Actividad05.utils.Student;
...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(s1.getNombre() + ": " + s1.getPromedio());
        System.out.println(s2.getNombre() + ": " + s2.getPromedio());
